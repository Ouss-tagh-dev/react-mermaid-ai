...
function App() {
    ...
    try {
      ...
      while (retries > 0) {
        try {
          ...
          const errorMsg =
            parseError.message || parseError.str || "Mermaid syntax error";
          console.warn(
            `Syntax error detected. Retries left: ${retries}. Message:`,
            errorMsg,
          );

          if (retries === 1) {
            throw new Error(
              "Unable to generate a valid diagram after multiple attempts.",
            );
          }
  ...
  const handleSaveSettings = () => {
    ...
    saveGroqConfig(apiKey, selectedModel);
  ...
  const handleClearSettings = () => {
    if (
      window.confirm(
        "Are you sure you want to clear your API Key and settings?",
      )
    ) {
      clearGroqConfig();
      setApiKey("");
    ...
    <div className="app-container">
      ...
      <footer className="footer">
        <p>
          ...
          <a
            href="https://oussama.taghlaoui.com/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Portfolio
          ...
          <a
            href="https://github.com/Ouss-tagh-dev/react-mermaid-ai"
            target="_blank"
            rel="noopener noreferrer"
          >
            GitHub Repo
